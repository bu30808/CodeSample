...
void UStatusEffect_Chill::OverrideAttributeEffects_Implementation(ABaseCharacter* Target, AActor* EffectBy)
{
	if (auto attComp = Target->GetAttributeComponent())
	{
		...
		newEffects.Add(FAttributeEffect(EAttributeType::ActionSpeed, EAttributeApplyMethod::REMOVE,
		                                attComp->GetActionSpeed() * resultAmount));
		newEffects.Add(FAttributeEffect(EAttributeType::MoveSpeed, EAttributeApplyMethod::REMOVE,
		                                attComp->GetMoveSpeed() * resultAmount));
...
void UStatusEffect_Freeze::EndEffect_Implementation(ABaseCharacter* Target)
{
	...
	if (auto attComp = Target->GetAttributeComponent())
	{
		attComp->OnUpdateStatusEffect.Broadcast(EStatusEffect::CHILL, attComp->GetChillAcc(),
		                                        attComp->GetChillResist());
	}
