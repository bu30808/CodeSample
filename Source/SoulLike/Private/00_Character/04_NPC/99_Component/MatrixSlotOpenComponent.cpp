...
UMatrixSlotOpenComponent::UMatrixSlotOpenComponent()
{
...
void UMatrixSlotOpenComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UMatrixSlotOpenComponent::PostInitProperties()
{
...
void UMatrixSlotOpenComponent::OnOrbMatrixSlotOpenWidgetVisibilityChangedEvent(ESlateVisibility InVisibility)
{
...
void UMatrixSlotOpenComponent::CreateOrbMatrixSlotOpenWidget(ABaseCharacter* InteractPlayer)
{
		...
		if (OrbMatrixSlotOpenWidgetObject && InteractPlayer != nullptr)
		{
			if (const auto pc = InteractPlayer->GetController<APlayerController>())
			{
				...
				OrbMatrixSlotOpenWidget->OnVisibilityChanged.AddUniqueDynamic(
					this, &UMatrixSlotOpenComponent::OnOrbMatrixSlotOpenWidgetVisibilityChangedEvent);
...
void UMatrixSlotOpenComponent::AddOrbMatrixSlotOpenWidget(ABaseCharacter* InteractPlayer)
{
...
void UMatrixSlotOpenComponent::UnLock(APlayerController* PlayerController,
...
bool UMatrixSlotOpenComponent::IsAllOpen(const TArray<FOrbMatrixElementInfo>& Line)
{
...
void UMatrixSlotOpenComponent::GivePhysicalLineCompleteReward(APlayerController* PlayerController, bool bShowAlert)
{
...
void UMatrixSlotOpenComponent::GiveMagicalLineCompleteReward(APlayerController* PlayerController, bool bShowAlert)
{
	if (SlotOpenRewardDataAsset)
	{
		if (auto abComp = PlayerController->GetPawn<APlayerCharacter>()->GetAbilityComponent())
...
void UMatrixSlotOpenComponent::GiveDefenceLineCompleteReward(APlayerController* PlayerController, bool bShowAlert)
{
	if (SlotOpenRewardDataAsset)
	{
		if (auto abComp = PlayerController->GetPawn<APlayerCharacter>()->GetAbilityComponent())
...
void UMatrixSlotOpenComponent::GiveFreeLineCompleteReward(APlayerController* PlayerController, bool bShowAlert)
{
	if (SlotOpenRewardDataAsset)
	{
		if (auto abComp = PlayerController->GetPawn<APlayerCharacter>()->GetAbilityComponent())
...
void UMatrixSlotOpenComponent::GiveLineCompleteReward(APlayerController* PlayerController,
...
void UMatrixSlotOpenComponent::OpenSlot(UOrbMatrix* CoreMatrix, const FOrbMatrixElementInfo& SelectedMatrixElement)
{
...
bool UMatrixSlotOpenComponent::HaveEnoughCost(APlayerController* PlayerController, const int32& Cost)
{
	if (const auto attComp = PlayerController->GetPawn<ABaseCharacter>()->GetAttributeComponent())
	{
...
bool UMatrixSlotOpenComponent::IsOpenPreSlot(const TArray<FOrbMatrixElementInfo>& Line, const int32& Index)
{
...
TArray<FOrbMatrixElementInfo> UMatrixSlotOpenComponent::GetLine(UOrbMatrix* CoreMatrix,
