...
public:
	...
	static void AttributeEffectElementToStatusEffectValues(class UAttributeComponent* AttributeComponent,
	                                                       EAttributeType AttributeType, EStatusEffect& StatusEffect,
	                                                       float& AccValue, float& ResistValue);
};
